...
exports.Dramaturgia = void 0;
var Dramaturgia = /** @class */ (function () {
    function Dramaturgia() {
    }
    Dramaturgia.prototype.setTitulo = function (titulo) {
        this.titulo = titulo;
    };
    Dramaturgia.prototype.setTexto = function (texto) {
        this.texto = texto;
    };
    Dramaturgia.prototype.setTituloPublico = function (titulo) {
        this.tituloPublico = titulo;
    };
    Dramaturgia.prototype.setAutor = function (autor) {
        this.autor = autor;
    };
    Dramaturgia.prototype.setAutorPublico = function (autor) {
        this.autorPublico = autor;
    };
    Dramaturgia.prototype.getTitulo = function () {
        return this.titulo;
    };
    Dramaturgia.prototype.getTexto = function () {
        return this.texto;
    };
    Dramaturgia.prototype.getTituloPublico = function () {
        return this.tituloPublico;
    };
    Dramaturgia.prototype.getAutor = function () {
        return this.autor;
    };
    Dramaturgia.prototype.getAutorPublico = function () {
        return this.autorPublico;
    };
    return Dramaturgia;
}());
exports.Dramaturgia = Dramaturgia;
var dramaturgias;
dramaturgias = [];
var aabelinhasonhadora = new Dramaturgia();
...
var aguerradosplanetas = new Dramaturgia();
...
var aloucadamontanha = new Dramaturgia();
...
var amanhaquemsabe = new Dramaturgia();
...
var aprovidencia = new Dramaturgia();
...
var astresdatas = new Dramaturgia();
...
var brasileiroseportugueses = new Dramaturgia();
...
var cabecadomundo = new Dramaturgia();
...
var compraseummarido = new Dramaturgia();
...
var dialogodasestrelas = new Dramaturgia();
...
var formacaorural = new Dramaturgia();
...
var oanjodameianoite = new Dramaturgia();
...
var onatalnoespacosideral = new Dramaturgia();
...
var omenordosmeusirmaos = new Dramaturgia();
...
var osanjosdoclaustro = new Dramaturgia();
...
var pelasgrades = new Dramaturgia();
...
var pertinhodoceu = new Dramaturgia();
...
var seusoldonalua = new Dramaturgia();
...
var umjardimchamadogetsemani = new Dramaturgia();
...
var umrestodehomem = new Dramaturgia();
